...
void setup() 
{
    Serial.begin(115200); // serial thru usb
    delay(100);  //give us a moment to bring up the Serial

    Serial.println("setup()");
    
    Serial2.begin(115200, SERIAL_8N1, RX2, TX2); // UART comms from the ROMI
...
void loop() 
{
    ...
    */
    ...
    if(bootButton.checkButtonPress()) {String bStr("evan/button0:1"); publishMQTT(bStr);}    
}