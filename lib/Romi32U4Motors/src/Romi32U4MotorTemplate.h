...
protected: 
    ...
    // Clamping value of integral term error
    int maxEffort = 420;
    ...
    */
    void ControlMotorSpeed(bool debug = false)
    {
        if(ctrlMode == CTRL_SPEED)
        {
            ...
            if(debug)
            {          
                Serial.print(">Target Speed (Ticks/Interval):");  
                Serial.print(targetSpeed);
                Serial.print('\n');

                Serial.print(">Measured Speed (Ticks/Interval):");
                Serial.print(speed);
                Serial.print('\n');
                ...
                Serial.print(">Controller Effort:\t");
...
protected:
    ...
    void InitializeMotor(void)
    {
        ...
        //allowTurbo(true); // remove motor limits
        InitializeEncoder();
    }
