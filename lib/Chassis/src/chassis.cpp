...
{
    leftSpeedCMperSec*=LEFT_CM_S_TO_TICKS_INT; //(1/(3.1416 * 7.0)) * ((12.0 * (3952.0/33.0))) * (20/1000); //LEFT_CM_S_TO_TICKS_INT;
    rightSpeedCMperSec*=RIGHT_CM_S_TO_TICKS_INT; //(1/(3.1416 * 7.0)) * ((12.0 * (3952.0/33.0))) * (20/1000); //RIGHT_CM_S_TO_TICKS_INT;
