...
#define INTERSECTION_LOWER_THRESHOLD 400
#define INTERSECTION_UPPER_THRESHOLD 600
#define EDGE_THRESHOLD 900

#define LINE_FOLLOWER_KP 0.001
#define LINE_FOLLOWER_KD 0.00005

#define LINE_FOLLOW_LINEAR_SPEED 15
